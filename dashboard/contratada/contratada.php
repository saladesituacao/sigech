<?php if (permissao_acesso(103)) { ?>
    ...
    <div role="tabpanel" class="tab-pane active" id="sc">
    ...
    while ($linhaServicoContratado = pg_fetch_row($rsServicoContratado)){
        ...
        <tr> 
                        <td> <?php echo $linhaServicoContratado[9];?><?php echo $linhaServicoContratado[10];?> - <?php echo $linhaServicoContratado[11];?></td>
                        ...
                        <?php if (((permissao_acesso(316) && $perfil->RetornaPerfil($acesso->usuario->perfil) == $estabelecimento) || $acesso->usuario->perfil == 1)){ ?>
                                <button class='btn btn-default btn-xs' onClick="desativar('<?php echo $linhaServicoContratado[0];?>','<?php echo $linhaServicoContratado[1];?>')"><i class='fa fa-times-circle' style='font-size:24px;color:red'></i>Desabilitar</button>
                        <?php } ?>
                        </td>
