...
if (empty($_REQUEST['log'])) {
	Auditoria(55, "Acessar Relatório de NC pendentes na DIVISA", "");
}
...
?>
    ...
    <div class="well text-center">
		...
		<b>
		Nº DE NÃO CONFORMIDADES PENDENTES NA DIVISA (por mês)</b>
...
<!-- Nº DE NÃO CONFORMIDADES PENDENTES NA DIVISA (por mês) -->
