...
if (empty($_REQUEST['log'])) {
	Auditoria(58, "Acessar Relatório de Conformidades Solucionadas pelas Unidades", "");
}
...
?>
    ...
    <div class="well text-center">
		...
		<b>
		Nº DE NÃO CONFORMIDADES CONCLUÍDAS E ENCAMINHADAS PARA DIVISA (por responsável) 
		 </b>
